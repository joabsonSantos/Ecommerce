        ...
        <div class="container bg-light mt-4 rounded shadow-1">
            <div class="row">
                ...
                <div class="col p-4">
                    ...
                    <div class="d-flex justify-content-around align-items-center m-2 p-2">
                        <h1 class="title text-center w-100">PEDIDOS</h1>

                        <button type="button" class="btn btn-md btn-outline-success rounded rounded-circle">
                        ...
                        <table class="table table-sm table-hover table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    <td>teste</td>
                                    <td>teste</td>
                                    <td>Lorem ipsum, dolor sluptatem orem ipsum, dolor sluptatem orem ipsum, dolor
                                        sluptatem.</td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="editePedido"><span>&times;<span></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <details class="form-control">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-md-6">
                                        <label for="inputNumnota">Nº Nota:</label>
                                        <input type="text" class="form-control" id="inputNumnota" disabled>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <label for="inputNumpedi">Nº Pedido:</label>
                                        <input type="text" class="form-control" id="inputNumpedi" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputValor" disabled>
                                    </div>
                                </div>
                            </details>
                            <hr>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-danger px-5" type="button" data-dismiss="modal">Cancelar</button>
